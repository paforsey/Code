...
**Fig 1.2**  The boxplot graph appears to indicate that average tooth growth and dose are positively correlated; as the dose increases, tooth length also increases.  The lack of overlap between the three doses seems to indicate that the difference in growth rate may be statistically significant.  
