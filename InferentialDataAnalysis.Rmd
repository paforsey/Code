...
The boxplot graph appears to indicate that the supplement in OJ results in higher average tooth lenth than the supplement in VC.  However, the amount of overlap between the two seems to indicate that the difference may not be statistically significant.
