...
#   The Effect of Dose on Tooth Growth
    ...
    g1 <- g1 + geom_boxplot() 
    g1 <- g1 + ggtitle("Fig 1.1: Tooth Growth vs Supplement") + labs(x="Supplement", 
        y="Tooth Length")
    g1
```

**Fig 1.2**  The boxplot graph appears to indicate that average tooth growth and dose are positively correlated; as the dose increases, tooth length also increases.  The lack of overlap between the three seems to indicate that the difference may be statistically significant.  
```{r Exploratory2, include=T, eval=T, echo=T}
#   The Effect of Dose on Tooth Growth
    g2 <- ggplot(ToothGrowth, aes(x=factor(dose), y=len, fill=factor(dose)))
    g2 <- g2 + geom_boxplot() 
    g2 <- g2 + ggtitle("Fig 1.2: Tooth Growth vs Dose") + labs(x="Dose", y="Tooth Length")
    g2
```
  
**Fig 1.3**  The boxplot graph appears to indicate that average tooth growth and dose are positively correlated for both supplements; as the dose increases, tooth length also increases.  It is interesting to note that OJ results in higher levels of average tooth growth for the 0.5mg and 1.0mg doses.  However, there appears to be little or no difference for the 2.0mg dose.  
...
#   The Combined Effects of Supplement & Dose on Tooth Growth
    ...
    g3 <- g3 + ggtitle("Fig 1.3: Tooth Growth vs Supplement & Dose") + labs(x="Dose", 
        y="Tooth Length")
    g3
```
...
**There is a statistically significant difference in the level of tooth growth between doses.  There is a positive correlation between the level of tooth growth and the size of each dose; as dose size increases, tooth length increases.  See the box plot in Fig 1.2 above and the t-test results below.**  
