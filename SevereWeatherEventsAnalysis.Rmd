...
Analysis revealed that the severe weather event most harmful to both property and population health was Tornado.  The overall impact was approximately $51.99 billion in property damage and almost 97,000 injuries and fatalities occurring from JAN 1950 through NOV 2011.  The state most affected was Texas with approximately $19.5 billion in property damage and more than 19,000 injuries and fatalities.  
...
#   Property Damage: Top 10 EVTYPE
    ...
    Column1 <- gvisColumnChart(ECONOMIC,
        ...
        vAxis="{title:'Property Damage ($ Billions)'}", colors="['#A36685']"));
    plot(Column1);
    
```
  
    
Figure 1.1: The top ten severe weather events are responsible over 80% of the total amount of property damage.
...
#   Population Health: Top 10 EVTYPE
    ...
    Column2 <- gvisColumnChart(HEALTH,
        ...
        vAxis="{title:'Injuries & Fatalities'}", colors="['#8080E6']"));
    plot(Column2);
```
  
    
Figure 2.1: The top ten severe weather events attributed to over 85% of the total number fatalities and injuries.
