...
Total Property Damage = Amount of Property Damage ($) + Amount of Crop Damage ($)
...
```{r EconomicsImpactMap, include=T, echo=F, results='asis', tidy=F}
    ...
    plot(Geo1);
```
Texas was the hardest hit with a combined total of $19.5 Billion in combined property and crop damage from JAN 1950 through NOV 2011.
...
```{r PopulationHealthMap, include=T, echo=F, results='asis', tidy=F}
