...
Notes:
The scope of this analysis does not include US territories, such as Guam and the Virgin Islands, as they represent less than 2% of the overall effect of severe weather events.
```{r echo=F}
    options(op);
```
